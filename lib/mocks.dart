...
8 комфортабельных номеров, дизайн каждого из них выполнен в определенном этническом стиле разных уголков мира с национальными особенностями оформления интерьера и элементов декора. В шаговой доступности располагается фитнес-клуб, спа, бассейн, кинотеатр, кафе, магазины, набережная, торгово-развлекательный центр."      
''',
    type: 'Гостиница',
  ),
  Sight(
